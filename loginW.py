...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.register_pushButton.setGeometry(QtCore.QRect(70, 200, 111, 28))
        self.register_pushButton.setObjectName("register_pushButton")
        self.login_pushButton = QtWidgets.QPushButton(LoginWindow)
        self.login_pushButton.setGeometry(QtCore.QRect(222, 200, 111, 28))
        self.login_pushButton.setObjectName("login_pushButton")
        self.userName_label = QtWidgets.QLabel(LoginWindow)
        self.userName_label.setGeometry(QtCore.QRect(70, 70, 72, 15))
        self.userName_label.setObjectName("userName_label")
        self.password_label = QtWidgets.QLabel(LoginWindow)
        self.password_label.setGeometry(QtCore.QRect(70, 130, 72, 15))
        self.password_label.setObjectName("password_label")
        self.userName_lineEdit = QtWidgets.QLineEdit(LoginWindow)
        self.userName_lineEdit.setGeometry(QtCore.QRect(140, 65, 191, 21))
        self.userName_lineEdit.setObjectName("userName_lineEdit")
        self.password_lineEdit = QtWidgets.QLineEdit(LoginWindow)
        self.password_lineEdit.setGeometry(QtCore.QRect(140, 125, 191, 21))
